...
export const GROUP_DATA: Group[] = [
    ...
    {id: 2, name: 'Grupo Azul', member_id: [2, 4, 7], message_id: [4, 5, 6], file_id: [], description: 'Este es el grupo azul'},
    {id: 3, name: 'Grupo Negro', member_id: [5, 6, 9], message_id: [7, 8, 9], file_id: [], description: 'Este es el grupo negro'},
